...
namespace NeoBurger
{
    ...
    public class NeoBurgerGovernanceToken : Nep17Token
    {
        ...
        public override byte Decimals { [Safe] get => 10; }
        public override string Symbol { [Safe] get => "NOBUG"; }
        ...
        {
            Storage.Put(Storage.CurrentContext, new byte[] { PREFIX_TEE }, INITIAL_OWNER);
        }
