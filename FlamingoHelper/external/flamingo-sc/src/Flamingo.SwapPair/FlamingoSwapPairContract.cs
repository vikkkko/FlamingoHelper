...
namespace Flamingo.SwapPair
{
    ...
    public partial class FlamingoSwapPairContract : SmartContract
    {
        ...
        private static readonly UInt160 TokenA = "0x0000000000000000000000000000000000000000";
        private static readonly UInt160 TokenB = "0x0000000000000000000000000000000000000000";
        ...
        public static void _deploy(object data, bool update)
        {
            ...
            ExecutionEngine.Assert(StorageGet("token0") is null && StorageGet("token1") is null, "Tokens already set");
            ExecutionEngine.Assert(TokenA.IsValid && !TokenA.IsZero, "Invalid TokenA is invalid.");
            ExecutionEngine.Assert(TokenB.IsValid && !TokenB.IsZero, "Invalid TokenB is invalid.");
            ExecutionEngine.Assert(TokenA != TokenB, "TokenA and TokenB are the same");

            Contract TokenAContract = ContractManagement.GetContract(TokenA);
            Contract TokenBContract = ContractManagement.GetContract(TokenB);
            ExecutionEngine.Assert(TokenAContract != null, "TokenA contract not found");
            ExecutionEngine.Assert(TokenBContract != null, "TokenB contract not found");
