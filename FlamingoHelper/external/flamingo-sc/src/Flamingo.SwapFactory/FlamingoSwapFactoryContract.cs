...
using Flamingo.FlamingoSwapFactory.Models;
using Flamingo.SwapFactory.Models;
...
{
    [DisplayName("FlamingoSwapFactory")]
    [ManifestExtra("Author", "Flamingo Finance")]
    [ManifestExtra("Email", "developer@flamingo.finance")]
    [ManifestExtra("Description", "This is a Flamingo Contract RC6")]
